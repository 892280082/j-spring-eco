...
import { SpringDataSource } from './springTx';
...
abstract class BaseDataSourceConnect extends SpringContainer
  implements SpringStarter {
  async doStart(clazzMap: ClazzExtendsMap): Promise<any> {
    ...
    clazzMap.addBean(
      SpringDataSource as Clazz,
      new SpringDataSource(dataSource.manager),
      'spring封装的dataSource'
    );
  }
