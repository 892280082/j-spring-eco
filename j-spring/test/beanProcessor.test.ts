import { Value,Component,launch, Autowired ,BeanPostProcessor,BeanDefine, SpringContainer, spring} from "../src";
...
describe('test beanProcessor',()=>{
    ...
    it('test bind class',()=>{
        ...
        expect(spring.bind(ApiController).launch(Application)).toEqual('already instance')
